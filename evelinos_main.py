...
while True:
    ...
    elif event == all_channels[0]:
        playing = song_status(event)
        button(0, 0, event, playing)
    elif event == all_channels[1]:
        playing = song_status(event)
        button(1, 1, event, playing)
    elif event == all_channels[2]:
        playing = all_channels(event)
        button(2, 2, event, playing)
    elif event == all_channels[3]:
        playing = song_status(event)
        button(3, 3, event, playing)
    elif event == all_channels[4]:
        playing = song_status(event)
        button(4, 4, event, playing)
    elif event == all_channels[5]:
        playing = song_status(event)
        button(5, 5, event, playing)
    elif event == all_channels[6]:
        playing = song_status(event)
        button(6, 6, event, playing)
    elif event == all_channels[7]:
        playing = song_status(event)
